hljs.registerLanguage("xsharp",(()=>{"use strict";return _=>{const E={
className:"string",variants:[{begin:'"',end:'"',contains:[_.BACKSLASH_ESCAPE],
relevance:0},{begin:"'",end:"'",relevance:0}]};return{name:"xsharp",
