var hljsGrammar=(()=>{"use strict";return _=>({name:"xsharp",
...
},contains:[{scope:"string",variants:[{begin:'"',end:'"',
contains:[_.BACKSLASH_ESCAPE],relevance:0},{begin:"'",end:"'",relevance:0}]},{
scope:"meta string",begin:/\B#\w+\b/},_.COMMENT("//","$",{contains:[{
scope:"doc",begin:/\\\n/}]}),_.COMMENT("/\\*","\\*/",{contains:[{scope:"doc",
begin:"@\\w+"}]}),{
